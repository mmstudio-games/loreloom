...
pub use config::{
    ...
    NARRATOR_REQUEST_NPC_TURN_CAPABILITY, NARRATOR_SUBMIT_NPC_DRAFT_CAPABILITY,
    NARRATOR_TRANSITION_SCENE_CAPABILITY, NpcResourcePolicy, OrchestrationBudget, RuntimeConfig,
};
